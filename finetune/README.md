...
1. DATASET_CSV_NAME: Path to the dataset CSV file (default: `dataset.csv`).
2. TRAIN_CSV_NAME: Path to the training CSV file (default: `train.csv`).
3. TEST_CSV_NAME: Path to the test CSV file (default: `test.csv`).
4. TEST_RATIO: Ratio of test data to total data (default: `0.2`).
...
4. GPU_MEMORY_UTILIZATION: GPU memory utilization for vLLM (default: `0.5`).
